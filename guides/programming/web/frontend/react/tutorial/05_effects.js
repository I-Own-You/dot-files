// effect
//
// (the name is from the idea of side effect that is usually made outside of rendering)
// effects is a powerful tool, but also easy to make bugs with.
//
...
//    2. if you do specify dependencies, the effect will track them an use the effect everytime,
//       they change.
useEffect(() => {
  // Code here will run after *every* render
}, []);
...
//    on the second rerender/remount, so no bugs.)
