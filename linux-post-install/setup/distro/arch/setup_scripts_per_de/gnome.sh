# gnome
sudo pacman -S dconf-editor gnome-tweaks gdm-settings nwg-look grim flameshot qt5ct qt6ct qt5-wayland qt6-wayland kvantum kvantum-qt5 kvantum-qt6 gnome-browser-connector
# gsettings
