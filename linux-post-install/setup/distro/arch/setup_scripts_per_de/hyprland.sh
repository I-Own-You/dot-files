# hyprland
sudo pacman -S btop udiskie udisks2 playerctl xdg-desktop-portal xdg-desktop-portal-gtk xdg-desktop-portal-hyprland swaync nmrs overskride-bin grim flameshot polkit-gnome hyprpaper waypaper hyprpicker dolphin hyprlock hyprsunset
# styling
